...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE books SET title='$title', price='$price', stock='$stock', author='$author', description='$description',original_price='$original_price',discount_percentage='$discount_percentage',rating='$rating' WHERE id=$id";
    
    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Book updated successfully'); window.location='product.php';</script>";
    } else {
...
<div class="container">
    ...
    <a href="product.php" class="back-link">← Back to Book List</a>
</div>
