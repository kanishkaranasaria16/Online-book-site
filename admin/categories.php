...
if (isset($_GET['delete'])) {
    ...
    if ($conn->query($deleteQuery) === TRUE) {
        echo "<script>alert('Book deleted successfully!'); window.location=' categories.php';</script>";
    } else {
...
<div class="content">
        ...
        <?php while ($row = $result->fetch_assoc()) { ?>
            <tr>
                ...
                <td class="action-buttons">
                    <a href="edit_categories.php?id=<?= $row['id']; ?>" title="Edit">
    ...
    <button class="update-btn" onclick="window.location.href='add_categories.php'"><b>ADD BOOK</b></button>
</div>
</body>
